...
export default function LayoutBlogPost({
  ...
  return (
    <>
      ...
      <button 
        onClick={() => router.back()}
        className="top-6 left-6 z-20 flex items-center gap-2 text-sm text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 transition-colors"
      >
